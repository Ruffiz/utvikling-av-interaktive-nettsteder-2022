...
try {
  ...
  /// functions default parameters ///
	...
	(function UseDefaultParameters() {
		...
		// function hello(who = "World", anotherWho = "React") {
		// 	return 'Hello ' + who + '!' || 'Hello ' + anotherWho + "!";
		// };
		const hello = (who = "World", anotherWho = "React") => {
			return `Hello ${who}!` || `Hello ${anotherWho}!`;
		}
  ...
  /// Object Spread Properties (ES2018) ///
	...
	(function UseObjectSpreadProperties2() {
		...
		// Andre forsøk var:
		// let results = { ...obj1, ...obj3, ...obj2 }; // <---- Sjekk feilen

		// Da startet brainstorm og mindfuck = overtenking... under...

		// Fant ut at dette fungerte og det gjør det, men ikke helt hva oppgaven ville..
		// let { a, ...obj1Rest} = obj1;
		// let { b, d, e} = obj2;
		// let { c, ...obj3Rest} = obj3;
		// let result = { a, b, c, d, e};

		// Ekstremt flaut etter ca. 6 timer koding på en søndag da jeg egentlig visste hva som var riktig
